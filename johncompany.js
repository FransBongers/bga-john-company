...
var NotificationManager = (function () {
    ...
    NotificationManager.prototype.notif_allocateBalanceToOffice = function (notif) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, companyBalance, officeTreasury, officeId, board;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = notif.args, companyBalance = _a.companyBalance, officeTreasury = _a.officeTreasury, officeId = _a.officeId;
...
var JohnCompany = (function () {
    function JohnCompany() {
        ...
        this.states = {
            ...
            CrownChairmanRequestAllocation: CrownChairmanRequestAllocation,
            CrownChairmanRequestDebtAdvancement: CrownChairmanRequestDebtAdvancement,
            CrownManagerOfShippingBuyCompanyShips: CrownManagerOfShippingBuyCompanyShips,
            CrownManagerOfShippingFitShips: CrownManagerOfShippingFitShips,
            CrownManagerOfShippingLeaseExtraShips: CrownManagerOfShippingLeaseExtraShips,
            CrownManagerOfShippingPlaceShips: CrownManagerOfShippingPlaceShips,
...
var Board = (function () {
    ...
    Board.prototype.setupSelectBoxes = function () {
        ...
        OFFICES_WITH_TREASURY.forEach(function (office) {
            var elt = (_this.ui.selectBoxes[office] = document.createElement('div'));
            elt.classList.add('joco-select-box');
...
var CrownChairmanRequestAllocation = (function () {
    function CrownChairmanRequestAllocation(game) {
        this.game = game;
    }
    CrownChairmanRequestAllocation.create = function (game) {
        CrownChairmanRequestAllocation.instance =
            new CrownChairmanRequestAllocation(game);
    };
    CrownChairmanRequestAllocation.getInstance = function () {
        return CrownChairmanRequestAllocation.instance;
    };
    CrownChairmanRequestAllocation.prototype.onEnteringState = function (args) {
        debug('Entering CrownChairmanRequestAllocation state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownChairmanRequestAllocation.prototype.onLeavingState = function () {
        debug('Leaving CrownChairmanRequestAllocation state');
    };
    CrownChairmanRequestAllocation.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may fit ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownChairmanRequestAllocation.prototype.updateInterfaceInitialStep = function () {
        var _this = this;
        this.game.clearPossible();
        var playerId = PlayerManager.getInstance().getCurrentPlayerId();
        updatePageTitle(_('${you} may pay 1 ${tkn_promiseCube} to request to allocate up to 3 ${tkn_pound} to a specific office'), {
            tkn_playerName: getCrownPlayerName(),
        ...
        addSecondaryActionButton({
            ...
            callback: function () { return _this.updateInterfaceSelectOffice(); },
        });
        addSecondaryActionButton({
            id: 'skip_btn',
            text: _('Skip'),
            callback: function () {
                return performAction('actCrownChairmanRequestAllocation', {
                    continue: true,
                });
            },
        });
    };
    CrownChairmanRequestAllocation.prototype.updateInterfaceSelectOffice = function () {
        clearPossible();
        updatePageTitle(_('${you} must select an office'));
        this.setOfficesSelectable();
        addCancelButton();
    };
    CrownChairmanRequestAllocation.prototype.updateInterfaceSelectAmount = function (officeId) {
        var _this = this;
        clearPossible();
        updatePageTitle(_('${you} must select the amount to request'));
        var _loop_2 = function (i) {
            addSecondaryActionButton({
                id: "amount_".concat(i, "_btn"),
                text: formatStringRecursive(_('${amount} ${tkn_pound}'), {
                    amount: i,
                    tkn_pound: tknPound(),
                }),
                callback: function () { return _this.updateInterfaceConfirm(officeId, i); },
            });
        };
        for (var i = 1; i <= this.args.maxAmount; i++) {
            _loop_2(i);
        }
        addCancelButton();
    };
    CrownChairmanRequestAllocation.prototype.updateInterfaceConfirm = function (officeId, amount) {
        clearPossible();
        updatePageTitle(_('Pay 1 ${tkn_promiseCube} to allocate ${amount} ${tkn_pound} to the ${office}?'), {
            tkn_promiseCube: tknPromiseCubes(),
            tkn_pound: tknPound(),
            amount: amount,
    ...
    CrownChairmanRequestAllocation.prototype.setOfficesSelectable = function () {
        var _this = this;
        var board = Board.getInstance();
        OFFICES_WITH_TREASURY.forEach(function (office) {
            var box = board.ui.selectBoxes[office];
            onClick(box, function () { return _this.updateInterfaceSelectAmount(office); });
        });
    };
    return CrownChairmanRequestAllocation;
}());
var CrownChairmanRequestDebtAdvancement = (function () {
    function CrownChairmanRequestDebtAdvancement(game) {
        this.game = game;
    }
    CrownChairmanRequestDebtAdvancement.create = function (game) {
        CrownChairmanRequestDebtAdvancement.instance =
            new CrownChairmanRequestDebtAdvancement(game);
    };
    CrownChairmanRequestDebtAdvancement.getInstance = function () {
        return CrownChairmanRequestDebtAdvancement.instance;
    };
    CrownChairmanRequestDebtAdvancement.prototype.onEnteringState = function (args) {
        debug('Entering CrownChairmanRequestDebtAdvancement state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownChairmanRequestDebtAdvancement.prototype.onLeavingState = function () {
        debug('Leaving CrownChairmanRequestDebtAdvancement state');
    };
    CrownChairmanRequestDebtAdvancement.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may fit ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownChairmanRequestDebtAdvancement.prototype.updateInterfaceInitialStep = function () {
        this.game.clearPossible();
        this.updatePageTitle();
        var playerId = PlayerManager.getInstance().getCurrentPlayerId();
        if (this.args.oneLessAdvancement.possible) {
            addSecondaryActionButton({
                ...
                extraClasses: !this.args.oneLessAdvancement.playerCanPay[playerId]
                    ...
                    : '',
                callback: function () {
                    return performAction('actCrownChairmanRequestDebtAdvancement', {
                        continue: false,
    ...
    CrownChairmanRequestDebtAdvancement.prototype.updateInterfaceConfirm = function () {
        clearPossible();
    ...
    CrownChairmanRequestDebtAdvancement.prototype.updatePageTitle = function () {
        if (this.args.currentDebt === this.args.newDebt) {
            updatePageTitle(_('${tkn_playerName} does not want to advance the Debt marker'), {
                tkn_playerName: getCrownPlayerName(),
            });
        }
        else {
            updatePageTitle(_('${tkn_playerName} wants to increase Company Debt to ${tkn_boldText_debtValue}'), {
                tkn_playerName: getCrownPlayerName(),
                tkn_boldText_debtValue: this.args.newDebt,
            });
        }
    };
    return CrownChairmanRequestDebtAdvancement;
}());
var CrownManagerOfShippingBuyCompanyShips = (function () {
    function CrownManagerOfShippingBuyCompanyShips(game) {
        this.game = game;
    }
    CrownManagerOfShippingBuyCompanyShips.create = function (game) {
        CrownManagerOfShippingBuyCompanyShips.instance =
            new CrownManagerOfShippingBuyCompanyShips(game);
    };
    CrownManagerOfShippingBuyCompanyShips.getInstance = function () {
        return CrownManagerOfShippingBuyCompanyShips.instance;
    };
    CrownManagerOfShippingBuyCompanyShips.prototype.onEnteringState = function (args) {
        debug('Entering CrownManagerOfShippingBuyCompanyShips state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownManagerOfShippingBuyCompanyShips.prototype.onLeavingState = function () {
        debug('Leaving CrownManagerOfShippingBuyCompanyShips state');
    };
    CrownManagerOfShippingBuyCompanyShips.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may buy  Company ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownManagerOfShippingBuyCompanyShips.prototype.updateInterfaceInitialStep = function () {
        this.game.clearPossible();
        this.updatePageTitle();
        var playerId = PlayerManager.getInstance().getCurrentPlayerId();
        var option = this.args.playerOptions[playerId];
        if (option) {
            switch (option.option) {
                case BUY_COMPANY_SHIP:
                    addSecondaryActionButton({
                        ...
                        callback: function () {
                            return performAction('actCrownManagerOfShippingBuyCompanyShips', {
    ...
    CrownManagerOfShippingBuyCompanyShips.prototype.updateInterfaceConfirm = function () {
        clearPossible();
        updatePageTitle(_('Confirm ship placement'));
        addConfirmButton(function () {
    ...
    CrownManagerOfShippingBuyCompanyShips.prototype.updatePageTitle = function () {
        var text = '';
        var currentPlayerId = PlayerManager.getInstance().getCurrentPlayerId();
        var shipsLog = {
            log: '',
            args: {},
        };
        this.args.shipsCrownWillBuy.forEach(function (ship, index) {
            var key = "tkn_ship_".concat(index);
            ship.type = COMPANY_SHIP;
            shipsLog.log += "${".concat(key, "}");
    ...
    return CrownManagerOfShippingBuyCompanyShips;
}());
var CrownManagerOfShippingFitShips = (function () {
    function CrownManagerOfShippingFitShips(game) {
        this.game = game;
    }
    CrownManagerOfShippingFitShips.create = function (game) {
        CrownManagerOfShippingFitShips.instance =
            new CrownManagerOfShippingFitShips(game);
    };
    CrownManagerOfShippingFitShips.getInstance = function () {
        return CrownManagerOfShippingFitShips.instance;
    };
    CrownManagerOfShippingFitShips.prototype.onEnteringState = function (args) {
        debug('Entering CrownManagerOfShippingFitShips state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownManagerOfShippingFitShips.prototype.onLeavingState = function () {
        debug('Leaving CrownManagerOfShippingFitShips state');
    };
    CrownManagerOfShippingFitShips.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may fit ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownManagerOfShippingFitShips.prototype.updateInterfaceInitialStep = function () {
        this.game.clearPossible();
        console.log('');
        this.updatePageTitle();
        addPrimaryActionButton({
            ...
            text: _('Continue'),
            callback: function () {
                return performAction('actCrownManagerOfShippingFitShips', {
                    continue: true,
                });
            },
        });
    };
    CrownManagerOfShippingFitShips.prototype.updateInterfaceConfirm = function () {
        clearPossible();
        updatePageTitle(_('Confirm ship placement'));
        addConfirmButton(function () {
    ...
    CrownManagerOfShippingFitShips.prototype.updatePageTitle = function () {
        var _a;
        var text = '';
        var currentPlayerId = PlayerManager.getInstance().getCurrentPlayerId();
        text = _('${tkn_playerName_crown} wants to fit ${ships_log}');
        if (this.args.playerPromiseCubeCost[currentPlayerId]) {
            text = _('${tkn_playerName_crown} wants to fit ${ships_log}. ${you} must pay ${amount} ${tkn_promiseCube}');
        }
        updatePageTitle(text, {
            tkn_playerName_crown: getCrownPlayerName(),
            tkn_promiseCube: tknPromiseCubes(),
            amount: (_a = this.args.playerPromiseCubeCost[currentPlayerId]) !== null && _a !== void 0 ? _a : 0,
            ships_log: getShipsLog(this.args.shipsThatWillBeFitted),
        });
    };
    return CrownManagerOfShippingFitShips;
}());
var CrownManagerOfShippingLeaseExtraShips = (function () {
    function CrownManagerOfShippingLeaseExtraShips(game) {
        this.game = game;
    }
    CrownManagerOfShippingLeaseExtraShips.create = function (game) {
        CrownManagerOfShippingLeaseExtraShips.instance =
            new CrownManagerOfShippingLeaseExtraShips(game);
    };
    CrownManagerOfShippingLeaseExtraShips.getInstance = function () {
        return CrownManagerOfShippingLeaseExtraShips.instance;
    };
    CrownManagerOfShippingLeaseExtraShips.prototype.onEnteringState = function (args) {
        debug('Entering CrownManagerOfShippingLeaseExtraShips state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownManagerOfShippingLeaseExtraShips.prototype.onLeavingState = function () {
        debug('Leaving CrownManagerOfShippingLeaseExtraShips state');
    };
    CrownManagerOfShippingLeaseExtraShips.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may lease extra ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownManagerOfShippingLeaseExtraShips.prototype.updateInterfaceInitialStep = function () {
        this.game.clearPossible();
        updatePageTitle(_('${tkn_playerName_crown} wants to lease ${count} ${tkn_ship}'), {
        ...
        var playerId = PlayerManager.getInstance().getCurrentPlayerId();
        var optionToLeaveTwoUnspent = this.args.optionToLeaveTwoUnspent[playerId];
        ...
        addPrimaryActionButton({
            ...
            text: _('Continue'),
            callback: function () {
                return performAction('actCrownManagerOfShippingLeaseExtraShips', {
                    continue: true,
                });
            },
        });
    };
    CrownManagerOfShippingLeaseExtraShips.prototype.updateInterfaceConfirm = function () {
        clearPossible();
        updatePageTitle(_('Confirm ship placement'));
        addConfirmButton(function () {
    ...
    return CrownManagerOfShippingLeaseExtraShips;
}());
var CrownManagerOfShippingPlaceShips = (function () {
    function CrownManagerOfShippingPlaceShips(game) {
        this.game = game;
    }
    CrownManagerOfShippingPlaceShips.create = function (game) {
        CrownManagerOfShippingPlaceShips.instance =
            new CrownManagerOfShippingPlaceShips(game);
    };
    CrownManagerOfShippingPlaceShips.getInstance = function () {
        return CrownManagerOfShippingPlaceShips.instance;
    };
    CrownManagerOfShippingPlaceShips.prototype.onEnteringState = function (args) {
        debug('Entering CrownManagerOfShippingPlaceShips state');
        this.args = args;
        this.updateInterfaceInitialStep();
    };
    CrownManagerOfShippingPlaceShips.prototype.onLeavingState = function () {
        debug('Leaving CrownManagerOfShippingPlaceShips state');
    };
    CrownManagerOfShippingPlaceShips.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} must place ships'), {
            tkn_playerName: getCrownPlayerName(),
        }, true);
    };
    CrownManagerOfShippingPlaceShips.prototype.updateInterfaceInitialStep = function () {
        this.game.clearPossible();
        updatePageTitle(_('${tkn_playerName_crown} wants to place ${shipsLog} in ${seaZone}'), {
        ...
        addPrimaryActionButton({
            ...
            text: _('Continue'),
            callback: function () {
                return performAction('actCrownManagerOfShippingPlaceShips', {
                    continue: true,
                });
            },
        });
    };
    CrownManagerOfShippingPlaceShips.prototype.updateInterfaceConfirm = function () {
        clearPossible();
        updatePageTitle(_('Confirm ship placement'));
        addConfirmButton(function () {
    ...
    return CrownManagerOfShippingPlaceShips;
}());
var CrownManagerOfShippingUnfittedShipOptions = (function () {
    function CrownManagerOfShippingUnfittedShipOptions(game) {
        this.game = game;
    }
    CrownManagerOfShippingUnfittedShipOptions.create = function (game) {
        CrownManagerOfShippingUnfittedShipOptions.instance =
            new CrownManagerOfShippingUnfittedShipOptions(game);
    };
    CrownManagerOfShippingUnfittedShipOptions.getInstance = function () {
        return CrownManagerOfShippingUnfittedShipOptions.instance;
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.onEnteringState = function (args) {
    ...
    CrownManagerOfShippingUnfittedShipOptions.prototype.onLeavingState = function () {
        debug('Leaving CrownManagerOfShippingUnfittedShipOptions state');
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.setDescription = function (activePlayerIds, args) {
        updatePageTitle(_('${tkn_playerName} may fit, buy and lease ships'), {
            tkn_playerName: getPlayerName(activePlayerIds[0]),
        }, true);
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.updateInterfaceInitialStep = function () {
        var _this = this;
        this.game.clearPossible();
        this.updatePageTitle();
        if (this.args.ship.id === this.ship.id && this.args.options.ships.length > 0) {
            addPrimaryActionButton({
                ...
                callback: function () { return _this.updateInterfaceSelectShip(); },
            });
        }
        if (true) {
            addPrimaryActionButton({
                ...
                callback: function () { return _this.updateInterfaceSelectSeaZone(); }
            });
        }
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.updateInterfaceSelectShip = function () {
        this.game.clearPossible();
        updatePageTitle(_('${you} must select a ship to fit'));
        addCancelButton();
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.updateInterfaceSelectSeaZone = function () {
        clearPossible();
        var board = Board.getInstance();
        updatePageTitle(_('${you} must select a sea zone'));
    };
    CrownManagerOfShippingUnfittedShipOptions.prototype.updateInterfaceConfirm = function () {
        clearPossible();
        updatePageTitle(_('Confirm ship placement'));
        addConfirmButton(function () {
    ...
    CrownManagerOfShippingUnfittedShipOptions.prototype.updatePageTitle = function () {
        var text = '';
        switch (this.args.phase) {
            case UNFITTED:
                text = _('${tkn_playerName_crown} wants to fit ${tkn_ship} and place it in ${location}');
                break;
            case COMPANY_SHIP:
                text = _('${tkn_playerName_crown} wants to fit ${tkn_ship} and place it in ${location}');
                break;
        ...
        var type = this.args.phase === UNFITTED ? this.args.ship.type : this.args.phase;
        updatePageTitle(text, {
            tkn_playerName_crown: getCrownPlayerName(),
            tkn_ship: tknShipValue({
                type: type,
    ...
    return CrownManagerOfShippingUnfittedShipOptions;
}());
...
var EnlistWriter = (function () {
    ...
    EnlistWriter.prototype.updateInterfaceConfirm = function (regionId) {
        clearPossible();
        setSelected(Board.getInstance().ui.selectBoxes["Writers_".concat(regionId)]);
...
var PresidencyTradeFillOrders = (function () {
    ...
    PresidencyTradeFillOrders.prototype.returnPieces = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _loop_3, this_1, _i, _a, _b, orderId, filledBy;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _loop_3 = function (orderId, filledBy) {
                            var promises, writer;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                    ...
                    case 1:
                        ...
                        return [5, _loop_3(orderId, filledBy)];
                    case 2:
                        _c.sent();
                        _c.label = 3;
                    case 3:
...
var StaticData = (function () {
    ...
    StaticData.prototype.office = function (id) {
...
var getCrownPlayerName = function () {
    return PlayerManager.getInstance().getPlayer(CROWN_PLAYER_ID).getName();
};
var getShipsLog = function (ships) {
    var shipsLog = {
        log: '',
        args: {},
    };
