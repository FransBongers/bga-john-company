...
class AtomicActions
{
  ...
  static $classes = [
    ...
    CROWN_CHAIRMAN_SEEK_DEBT => CROWN_CHAIRMAN_SEEK_DEBT,
    CROWN_MANAGER_OF_SHIPPING_BUY_COMPANY_SHIPS => CROWN_MANAGER_OF_SHIPPING_BUY_COMPANY_SHIPS,
    CROWN_MANAGER_OF_SHIPPING_FIT_SHIPS => CROWN_MANAGER_OF_SHIPPING_FIT_SHIPS,
    CROWN_MANAGER_OF_SHIPPING_LEASE_EXTRA_SHIPS => CROWN_MANAGER_OF_SHIPPING_LEASE_EXTRA_SHIPS,
    CROWN_MANAGER_OF_SHIPPING_PLACE_SHIPS => CROWN_MANAGER_OF_SHIPPING_PLACE_SHIPS,
